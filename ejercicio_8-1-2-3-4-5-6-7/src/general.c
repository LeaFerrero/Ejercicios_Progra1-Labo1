...
int myGets(char* string, int length)
{
	...
	if(string != NULL && length > 0)
	{
		...
		if(fgets(auxilliar, sizeof(auxilliar), stdin) != NULL)
		{
			...
			if(strnlen(auxilliar, sizeof(auxilliar)) <= length)
			{
				strncpy(string, auxilliar, length);
				rtn = 1;
			}
		 }
	 }
...
/// \param length Tamaño del array con la cadena a ser analizada
/// \return Retorna - en caso de error, 1 si la cadena es numerica y 0 si no
int verify_IsNumeric(char* string, int length)
{
	int rtn;
   	int i;
...
/// \param string Array con la cadena a ser analizada
/// \param length Tamaño del array con la cadena a ser analizada
/// \return Retorna - en caso de error, 1 si la cadena es numerica flotante y 0 si no
int verify_IsNumericFloat(char* string, int length)
{
	int rtn;
	int flagPoint;
...
int verify_IsAlphanumeric(char string[], int length)
{
    int rtn;
    int i;
...
int verify_IsLetters(char* string, int length)
{
    int rtn;
    int i;
...
///
/// \param string Array con la cadena a ser analizada
/// \param length Tamaño del array con la cadena a ser analizad
/// \return Retorna -1 en caso de error, 1 si la cadena esta compuesta por letras y 0 si no
int verify_IsLettersWithSpace(char* string, int length)
{
    int rtn;
    int i;
    int flagSpace;
...
int verify_IsLettersName(char* string, int length)
{
    int rtn;
    int i;
...
int get_Int(int* pNumber)
{
	...
	if(pNumber != NULL)
	{
		...
		if(myGets(auxilliar, sizeof(auxilliar)) == 1 && verify_IsNumeric(auxilliar, sizeof(auxilliar)) == 1)
		{
...
/// \return Retorna -1 en caso de error, 1 si obtuvo el flotante y 0 si no
int get_Float(float* pNumber)
{
	...
	if(pNumber != NULL)
	{
		...
		if(myGets(auxilliar, sizeof(auxilliar)) == 1 && verify_IsNumericFloat(auxilliar, sizeof(auxilliar)) == 1)
		{
...
/// \param length Tamaño del array donde la cadena va a ser copiada
/// \return Retorna -1 en caso de error, 1 si obtuvo el la cadena de letras y 0 si no
int get_StringLettters(char* string, int length)
{
	int rtn;
	char auxilliar[51];
	...
	if(string != NULL && length > 0)
	{
		...
		if(myGets(auxilliar, sizeof(auxilliar)) == 1 && verify_IsLetters(auxilliar, sizeof(auxilliar)) == 1)
		{
			if(strnlen(auxilliar, sizeof(auxilliar)) <= length)
			{
				strncpy(string, auxilliar, length);
...
/// \param string Array donde la cadena va a ser copiada
/// \param length Tamaño del array donde la cadena va a ser copiada
/// \return Retorna -1 en caso de error, 1 si obtuvo el la cadena y 0 si no
int get_StringAlphanumeric(char* string, int length)
{
	int rtn;
	char auxilliar[51];
	...
	if(string != NULL && length > 0)
	{
		...
		if(myGets(auxilliar, sizeof(auxilliar)) == 1 && verify_IsAlphanumeric(auxilliar, sizeof(auxilliar)) == 1)
		{
			if(strnlen(auxilliar, sizeof(auxilliar)) <= length)
			{
				strncpy(string, auxilliar, length);
...
/// \param length Longitud de la del array donde sera copiada
/// \return Retorna -1en caso de error, 1 si obtuvo la cadena y 0 si no
int get_StringName(char* string, int length)
{
	int rtn;
	char auxilliar[51];
	rtn = -1;
	...
	if(string != NULL && length > 0)
	{
		...
		if(myGets(auxilliar, sizeof(auxilliar)) == 1 && verify_IsLettersName(auxilliar, sizeof(auxilliar)) == 1)
		{
			if(strnlen(auxilliar, sizeof(auxilliar)) <= length)
			{
				strncpy(string, auxilliar, length);
...
/// \param min El numero minimo a ser aceptado
/// \param max El numero maximo a ser aceptado
/// \return Retorna -1 en caso de error, 1 si obtuvo el numero y 0 si no
int get_ValidInt(int* pNumber, char* message , char* errorMessage , int min, int max)
{
	...
	if(pNumber != NULL)
	{
		...
		do
		{
			...
			if(get_Int(&auxilliar) == 1 && verify_IsInRangeInt(auxilliar, min, max))
			{
				*pNumber = auxilliar;
				rtn = 1;
				break;
...
int get_ValidIntPositive(int* pNumber, char* message, char* errorMessage)
{
	...
	if(pNumber != NULL)
	{
		...
		{
			printf("%s: ", message);
			if(get_Int(&auxilliar) == 1 && verify_IsPositiveNegativeZero(auxilliar) == 1)
			{
				*pNumber = auxilliar;
				rtn = 1;
				break;
...
int get_ValidFloat(float* pNumber, char* message , char* errorMessage , float min, float max)
{
	...
	if(pNumber != NULL)
	{
		...
		do
		{
			...
			if(get_Float(&auxilliar) == 1 && verify_IsInRangeFloat(auxilliar, min, max))
			{
				*pNumber = auxilliar;
				rtn = 1;
				break;
...
/// \return Devuelve -1 en caso de error, 1 en caso de poder obtener la cadena y 0 si no
int get_ValidStingAlphanumeric(char* string, int length, char message [], char errorMessage [])
{
	int rtn;
	...
	if(string != NULL)
	{
		...
		do
		{
			...
			if(get_StringAlphanumeric(string, length) == 1)
			{
				rtn = 1;
				break;
			}
...
/// @param mensaje El mensaje a mostrar
/// @param errorMessage El mensaje de error a mostrar
/// \return Devuelve -1 en caso de error, 1 en caso de poder obtener la cadena y 0 en caso contrario
int get_ValidStingLetters(char* string, int length, char message [], char errorMessage [])
{
	int rtn;
	...
	if(string != NULL)
	{
		...
		do
		{
			...
			if(get_StringLettters(string, length) == 1)
			{
				rtn = 1;
				break;
			}
...
/// @param errorMessage El mensaje de error a mostrar
/// \return Devuelve -1 en caso de error, 1 en caso de poder obtener la cadena y 0 si no
int get_ValidName(char* string, int length, char* message, char* errorMessage)
{
	int rtn;
	...
	if(string != NULL)
	{
		...
		do
		{
			...
			if(get_StringName(string, length) == 1)
			{
				format_Name(string);
				rtn = 1;
				break;
...
int get_ValidFloatRetries(float* pNumber, char* message , char* errorMessage , float min, float max, int retries)
{
	...
	if(pNumber != NULL && retries > 0)
	{
		...
		{
			printf("%s (min %.2f, max %.2f): ", message , min, max);
			if(get_Float(&auxilliar) == 1 && verify_IsInRangeFloat(auxilliar, min, max)==1)
			{
				*pNumber = auxilliar;
				rtn = 1;
				break;
...
/// \param retries Cantidad de reintentos que tiene el usuario
/// \return Devuelve -1 en caso de error, 1 en caso de poder obtener la cadena y 0 si no
int get_ValidStingAlphanumericRetries(char* string, int length, char* message, char* errorMessage, int retries)
{
	int rtn;
...
/// @param errorMessage El mensaje de error a mostrar
/// \param retries Cantidad de reintentos que tiene el usuario
/// \return Retorna -1 en caso de error, 1 en caso de poder obtener la cadena y 0 si no
int get_ValidStingLettersRetries(char* string, int length, char* message, char* errorMessage, int retries)
{
	int rtn;
...
/// \param retries Cantidad de reintentos que tiene el usuario
/// \return Devuelve -1 en caso de error, 1 en caso de poder obtener la cadena y 0 si no
int get_ValidNameRetries(char* string, int length, char* message, char* errorMessage, int retries)
{
	int rtn;
