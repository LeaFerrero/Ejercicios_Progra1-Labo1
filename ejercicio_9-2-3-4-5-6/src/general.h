...
int get_ValidInt(int*, char*, char*);
int get_ValidIntPositive(int*, char*, char*);
int get_ValidIntRange(int*, char*, char*, int, int);
int get_ValidFloat(float*, char*, char*);
int get_ValidFloatRange(float*, char*, char*, float, float);
...
int menu(int*, char*, char*, char*, char*, char*, char*, char*, char*, char*);
int menuSN(char*);
